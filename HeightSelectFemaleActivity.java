...
public class HeightSelectFemaleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_heightselect_female);
        ...
        btnNext.setOnClickListener(v -> {
            if (selectedFeet == -1 || selectedInches == -1) {
                Toast.makeText(HeightSelectFemaleActivity.this, "Please select your height.", Toast.LENGTH_SHORT).show();
            } else {
                Intent intent = new Intent(HeightSelectFemaleActivity.this, BMIResultActivity2.class);
